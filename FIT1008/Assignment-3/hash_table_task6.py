...
def find_rank(filename):
    """
    This function reads finds the rank of the words that user inputs
    :param filename: name of the file from which to read lines
    :return:None
    :raises: None
    :precondition: alid filename is entered which exists
    :complexity: best and worst case is O(n) where n is the number of words the user enters
    :postcondition: All the ranks of the users words are shown
    """
