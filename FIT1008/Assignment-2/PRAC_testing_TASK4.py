import unittest
from Task4 import List
from Task4 import read_file
...
class test_Task4(unittest.TestCase):
    ...
    def test_setitem(self):
        ...
        my_list.append(2)
        self.assertRaises(IndexError, my_list.__setitem__, 0, 2)
        self.assertTrue(my_list.__setitem__(1,5))
    ...
    def test_append(self):
        ...
        my_list.append(2)
        self.assertTrue(my_list.append(5))

    def test_insert(self):
        my_list = List(2)
        self.assertRaises(AssertionError, my_list.insert, [], 2)
        self.assertRaises(IndexError, my_list.insert, -1, 2)
        self.assertRaises(IndexError, my_list.insert, 0, 2)
        my_list.append(1)
        my_list.append(2)
        self.assertRaises(IndexError, my_list.insert, 0, 2)
        self.assertTrue(my_list.insert(1,3))

    def test_read_file(self):
        my_list = List()
        self.assertFalse(read_file(my_list,'wieiwebif.txt'))
        self.assertTrue(read_file(my_list,'antibiot.txt'))
