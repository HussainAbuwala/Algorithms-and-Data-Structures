...
class Command_Line:
    ...
    def __init__(self):
        """
        This function makes List object named text_editor
        :param: None
        :return: None
        :raises: No exceptions
        :precondition: None
        :postcondition: None
        :complexity: best and worst case depends on the menu() and List() class
        """
    ...
    def menu(self):
        ...
        if data[0] == 'insert':
            ...
            if len(data) == 2:
                ...
                txt_check = user_filename.split('.')
                if len(txt_check) == 2 and txt_check[1] == 'txt' and txt_check[0].strip() != '':
                    check = self.Write_Filename(user_filename)
                    if check == False:
                        print('?')
                        self.menu()
                    else:
            ...
            if len(data) == 1:
                ...
                save_count = self.text_editor.count
